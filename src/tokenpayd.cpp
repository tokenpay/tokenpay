...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("TokenPay version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  tokenpayd [options]                     " + "\n" +
                  "  tokenpayd [options] <command> [params]  " + _("Send command to -server or tokenpayd") + "\n" +
                  "  tokenpayd [options] help                " + _("List commands") + "\n" +
                  "  tokenpayd [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "tokenpay:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect tokenpayd signal handlers
    noui_connect();
