#ifndef TOKENPAYBRIDGE_H
#define TOKENPAYBRIDGE_H
...
class TokenPayBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit TokenPayBridge(TokenPayGUI *window, QObject *parent = 0);
    ~TokenPayBridge();
