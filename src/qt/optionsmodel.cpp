...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::TPAY).toInt();
    ...
    fAutoRedeemTokenPay = settings.value("fAutoRedeemTokenPay", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemTokenPay:
            return fAutoRedeemTokenPay;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemTokenPay: return "AutoRedeemTokenPay";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::TPAY).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemTokenPay: {
            fAutoRedeemTokenPay = value.toBool();
            settings.setValue("fAutoRedeemTokenPay", fAutoRedeemTokenPay);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemTokenPay() { return fAutoRedeemTokenPay; }
