...
public:
    ...
    enum StatusCode // Returned by sendCoins
    {
        ...
        SCR_AmountWithFeeExceedsTokenPayBalance,
        SCR_Error,
        SCR_ErrorWithMsg,
        Aborted
    };
    ...
    qint64 getTokenPayBalance() const;
	...
	void emitBalanceChanged(qint64 balance, qint64 tokenpayBal, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance);
...
signals:
    ...
    void balanceChanged(qint64 balance, qint64 tokenpayBal, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance);
