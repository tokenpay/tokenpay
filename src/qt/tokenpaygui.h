...
#ifndef TOKENPAYGUI_H
#define TOKENPAYGUI_H
...
/**
  TokenPay GUI main class. This class represents the main window of the TokenPay UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TokenPayGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit TokenPayGUI(QWidget *parent = 0);
    ~TokenPayGUI();
